...
export default function MerchantDocsActionNeededEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Action needed on your {documentLabel} — {restaurantName}</Preview>
      <Body style={main}>
...
const noticeText: React.CSSProperties = { color: "#444444", fontSize: "14px", lineHeight: "1.6", margin: 0 };
