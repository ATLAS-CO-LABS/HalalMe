...
export default function MerchantContractEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your signed HalalMe Merchant Agreement - copy for your records
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              ...
              <strong>{restaurantName}</strong>. This email is your copy for
              your records. Below are the key details and the full terms you
              agreed to.
            </Text>
