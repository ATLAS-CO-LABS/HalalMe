  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-amber-950 to-gray-900">
      ...
      <section className="relative h-screen min-h-[600px] max-h-[900px] flex items-center overflow-hidden">
        ...
        {/* Ambient glow */}
        <div className="absolute bottom-0 left-1/4 w-[420px] h-[420px] bg-amber-600/12 rounded-full blur-3xl z-[1]" />
          ...
          <div className="max-w-3xl">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="group relative w-full sm:w-auto px-8 py-4 md:px-10 md:py-5 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold text-lg rounded-full shadow-xl shadow-amber-600/25 overflow-hidden"
              >
