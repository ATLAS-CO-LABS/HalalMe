    ...
    <aside className="w-64 md:w-56 bg-[#0e2420] flex flex-col h-full relative">
      ...
      <div className="relative px-5 pt-5 pb-4 border-b border-white/[0.08] flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#F7E7CE]/15 border border-[#F7E7CE]/20 flex items-center justify-center shrink-0">
            <span className="text-[#F7E7CE] font-bold text-sm leading-none">H</span>
          </div>
          <div>
            <p className={`${display.className} text-[#F7E7CE] font-extrabold text-lg leading-tight tracking-tight`}>HalalMe</p>
            <p className="text-white/35 text-[9px] font-semibold tracking-[0.15em] uppercase mt-0.5">
              Admin Panel
            </p>
          </div>
        </div>
      ...
      <div className="relative px-3 py-3 border-t border-white/[0.08] space-y-1">
        ...
        <Link
          href="/"
          onClick={onClose}
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-white/35 hover:text-white/70 hover:bg-white/[0.06] text-sm transition-all group"
        >
      ...
      <div className="md:pl-56 min-h-dvh flex flex-col">
        ...
        <div className="md:hidden sticky top-0 z-30 bg-[#0e2420] border-b border-white/8 px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-md bg-[#F7E7CE]/15 flex items-center justify-center">
              <span className="text-[#F7E7CE] font-bold text-xs leading-none">H</span>
            </div>
            <span className="text-[#F7E7CE] font-bold text-sm">HalalMe</span>
            <span className="text-white/30 text-[9px] font-semibold tracking-widest uppercase">Admin</span>
          </div>
          <div className="w-9" />
        </div>
